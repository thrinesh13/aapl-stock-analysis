...
This document describes the data used in the analysis, in the order it flows through the notebook: source data → preparation → engineered features → analysis outputs.
